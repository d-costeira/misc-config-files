...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first // CHANGE CHANGE enable
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 500 // CHANGE CHANGE enable
  ...
  #define BLTOUCH_FORCE_SW_MODE // CHANGE CHANGE enable
   ...
   */
  #define BLTOUCH_HS_MODE true // CHANGE CHANGE enable
 ...
 */
#define BABYSTEPPING // CHANGE CHANGE why the FUCK is this off you stupid piece of shit
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  5       // (steps or mm) Steps or millimeter distance for each Z babystep // CHANGE CHANGE 1->5
