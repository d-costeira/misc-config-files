...
#define B1_USE_BLTOUCH // CHANGE CHANGE must be defined
...
#define STRING_CONFIG_H_AUTHOR "(Eddie Coast, Piece a Shit)" // Who made the changes.
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe.  // CHANGE CHANGE old configs were true default is false
...
#define USE_PROBE_FOR_Z_HOMING // CHANGE CHANGE
...
// #define NOZZLE_TO_PROBE_OFFSET { 4, -47, 0 } // for BIQU Mount mounted on center
#define NOZZLE_TO_PROBE_OFFSET { -41, -10, 0 } // for Satsana Mount mounted on MicroSwiss direct drive carriage CHANGE CHANGE

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 10 // CHANGE CHANGE was 20 on biqu b1 configuration
...
#endif
#define EXTRA_PROBING    1  // CHANGE CHANGE enable
...
//#define Y_BED_SIZE 235
  // CHANGE CHANGE smaller bed size because of the shitass microswiss carriage + end
#define X_BED_SIZE 205
#define Y_BED_SIZE 205

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -3  // CHANGE CHANGE needed for 
#define Y_MIN_POS -5  // CHANGE CHANGE needed for 
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + 35)
#define Y_MAX_POS (Y_BED_SIZE + 20)
// #define Z_MAX_POS 270
#define Z_MAX_POS 200 // CHANGE CHANGE smaller due to MICRO SWISS direct drive
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION // CHANGE CHANGE enable
  ...
  #define GRID_MAX_POINTS_X 5 // CHANGE CHANGE
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  // Probe along the Y axis, advancing X after each column
  #define PROBE_Y_FIRST // CHANGE CHANGE enable
 ...
 */
#define Z_SAFE_HOMING // CHANGE CHANGE enable
 ...
 */
//#define NO_LCD_MENUS
#define SLIM_LCD_MENUS // CHANGE CHANGE enable
